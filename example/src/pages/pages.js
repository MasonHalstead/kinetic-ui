...
export const TabIndexPage = lazy(() => import('pages/tabindex/TabIndexPage'));
...
export const DropdownCalendarPage = lazy(() => import('pages/dropdowns/DropdownCalendarPage'));
export const DropdownCheckboxPage = lazy(() => import('pages/dropdowns/DropdownCheckboxPage'));
export const DropdownIconPage = lazy(() => import('pages/dropdowns/DropdownIconPage'));
...
export const TableBulkEditPage = lazy(() => import('pages/tables/TableBulkEditPage'));
